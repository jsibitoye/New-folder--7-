...
$q=mysql_query("insert into products(category,brand,name,year_man,price,colour,quantity,image,about) values('$cat','$brand','$nam','$year','$prc','$col','$qaunt','$pic','$abt')");
move_uploaded_file($tm,$pic);
}
else { echo 'yealjk'; die;}
if($q)
{echo 'sucesss oooo';} else{ echo 'error'.mysql_error();}
?>
...
<center>
 ...
 <div id="top">   <div id="me" align="center"><i><b>
  ...
  <I>ROLLO.COM, HOME OF CARS & INVESTMENTS</I>
  </marquee>
  </div>

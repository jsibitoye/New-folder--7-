...
<center>
 ...
 <div id="midh"><h1 align="center" style="font:30px Trebuchet MS; color: #666; text-shadow:1px 1px 120px blue; display:block; background: #FFC;"><i>Rollo &nbsp; <?php echo $tk; ?></i></h1>
<?php 
$a=2;
